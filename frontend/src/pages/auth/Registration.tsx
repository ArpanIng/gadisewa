...
import { type GarageCreate } from "../../schemas/garages.schema";
...
export default function Registration() {
  ...
  const {
    ...
    watch,
    formState: { errors },
  } = useForm<GarageCreate>();

  const onSubmit: SubmitHandler<GarageCreate> = (data) => console.log(data);
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full p-3 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 focus:ring-2 focus:ring-primary-500 outline-none"
                ...
                {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"].map(
                  (day) => (
                    <div key={day} className="flex items-center gap-4">
                      ...
                      <input
                        type="time"
                        className="p-2 rounded border border-slate-300 dark:border-slate-700 bg-transparent"
                        defaultValue="09:00"
                      />
                      <span>-</span>
                      <input
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <label
                    key={service}
                    className="flex items-center p-4 border border-slate-200 dark:border-slate-700 rounded-lg cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                  >
                    <input
                      type="checkbox"
                      className="w-5 h-5 rounded text-primary-600 focus:ring-primary-500"
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-4">
                  <div className="flex flex-col items-center justify-center p-4 border-2 border-primary-500 bg-primary-50 dark:bg-primary-900/20 rounded-xl w-32 h-32 cursor-pointer text-primary-700 dark:text-primary-300">
                    <span className="material-symbols-outlined text-4xl mb-2">
                      directions_car
                    </span>
                    <span className="font-bold">Car</span>
                  </div>
                  <div className="flex flex-col items-center justify-center p-4 border border-slate-200 dark:border-slate-700 rounded-xl w-32 h-32 cursor-pointer hover:border-primary-500">
              ...
              <div className="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full p-3 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 outline-none"
                      placeholder="Name"
                    />
                  </div>
                  <div>
